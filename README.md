...
- **👉 [NumberNova](https://github.com/AshishBamba05/histbytz-app)** — MVC-based architecture integrating TypeScript, Konva, & PostgreSQL to deliver end-to-end functionality of Interactive K-12 Math game. CI/CD testing pipeline using Jest.
