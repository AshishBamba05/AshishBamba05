...
- **🧩 [TritonHacks AI/ML Starter-Kit](https://github.com/tritonhacks/TritonHacks2025-ML-starter-kit)** — Built reproducible Python-based scikit-learn educational kits for TritonHacks, accelerating onboarding by engineering modular implementations of KNN, Logistic Regression, Random Forest, & MLP classifiers
  
- **🔊 CSES Innovate – ORCA Research** ([acknowledgement](https://drive.google.com/file/d/1B4LdDfa3dYvXjpXJPKUk4liswhSwPQd9/view)) — Built modular, AI-driven platform in Python, enabling E2E translation between audio, symbolic notation, & sheet music, securing awards at SoCal AI Responsibility Summit (SAIRS 2025) and San Diego Tech Conference (SDTC)
